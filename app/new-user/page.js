...
return (
    <main className="font-sans font-bold bg-blue-950 h-screen flex justify-center items-center">
        ...
        <div className="bg-linear-to-br from-emerald-200 to-teal-700 w-20 rounded-2xl">
        ...
        <form className="flex flex-col space-y-2 px-5 ">
            ...
            <input type="email"
                    ...
                    className="placeholder:font-medium placeholder:text-gray-400 placeholder:pl-1 rounded-xl border border-gray-300 px-2 py-2 hover:border-teal-700 hover:cursor-pointer focus:outline-1 focus:border-cyan-100"
            />
            <FontAwesomeIcon
            icon={faEnvelope}
            ...
            <div className="flex space-x-0.5">
                <input
                type="checkbox"/>
                <span className="font-medium text-sm text-gray-500">Remember me for 30 days</span>
            </div>
            ...
            <Link href="/user-dashboard"
                    className="w-full">
                <button className="w-full bg-teal-500 text-white rounded-md h-10 hover:bg-teal-600 hover:cursor-pointer">Sign Up</button>
            </Link>
        </form>
        ...
        <div className="flex gap-5">
            <button className="border border-gray-300 font-medium w-42 md:w-47 py-3 rounded-md flex justify-center items-center gap-2 hover:bg-teal-600 hover:cursor-pointer hover:text-white text-black"><FontAwesomeIcon icon={faGoogle} className="size-5 text-red-600"/>Google</button>
            <button className="border border-gray-300 font-medium w-42 md:w-47 py-3 rounded-md flex justify-center items-center gap-2 hover:bg-teal-600 hover:cursor-pointer hover:text-white text-black"><FontAwesomeIcon icon={faGithub} className="size-5 text-black"/>Github</button>
        </div>
        <span className="flex text-gray-400 text-sm font-medium py-3">Already have an account?
        ...
        <span className="flex text-gray-400 text-sm font-medium -my-2">Admin?

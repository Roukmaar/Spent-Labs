...
return (
    <main className="font-sans font-bold bg-blue-950 h-screen flex justify-center items-center">
        <div className="w-100 md:w-120 bg-white flex flex-col justify-center items-center py-10 rounded-2xl space-y-3 shadow-xl shadow-cyan-800">
        ...
        <form className="flex flex-col space-y-2 px-5 ">
            ...
            <FontAwesomeIcon
            icon={faEnvelope}
            className="relative -top-9.5 md:left-91 left-82  text-gray-400 size-5 pointer-events-none"
            />
            ...
            <FontAwesomeIcon
                icon={faEye}
                className="relative -top-19.5 md:-top-15.5 md:left-91 left-82  text-gray-400 size-5 pointer-events-none"
            />

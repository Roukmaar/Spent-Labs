      ...
      <div className='grid grid-cols-1 gap-6'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 hover:cursor-pointer w-full">
          <div className="col-span-2 bg-white p-6 rounded-lg shadow-sm">
            <h2 className="text-lg font-semibold text-black mb-4">Calendar</h2>
            <div className="grid grid-cols-7 text-center text-gray-600 text-sm gap-5">
              ...
              <div className="bg-blue-900 text-white rounded-full w-7 h-7 mx-auto p-1 -mt-1">13</div>
              ...
              <div className="text-sm space-y-4">
                <div>
                  ...
                  <div className='gap-3 flex'>
                    <span className="bg-blue-200 text-blue-900 text-xs px-2 py-0.5 rounded-full">Lecture</span>
                    <span className="bg-blue-200 text-blue-900 text-xs px-2 py-0.5 rounded-full">Virtual</span>
                  </div>
                </div>
                <div>
                  ...
                  <div className='gap-3 flex'>
                    <span className="bg-blue-200 text-blue-900 text-xs px-2 py-0.5 rounded-full">Symposium</span>
                    <span className="bg-blue-200 text-blue-900 text-xs px-2 py-0.5 rounded-full">Johannesburg</span>
                  </div>
                </div>
              </div>
            </div>

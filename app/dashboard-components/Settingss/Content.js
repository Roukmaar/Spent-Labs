    ...
    <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center text-xl font-semibold text-gray-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div>
            ...
            <input type="email" defaultValue="admin@spenddigitallab.com" className="w-full border rounded-md px-3 py-2" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Role</label>
            <input type="text" defaultValue="Administrator" className="w-full border rounded-md px-3 py-2" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Phone Number</label>
            <input type="text" defaultValue="+1 234 567 8900" className="w-full border rounded-md px-3 py-2" />
          </div>
        </div>

        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-1">Bio</label>
          <input type="text" defaultValue="Managing the Spent Digital Lab admin dashboard" className="w-full border rounded-md px-3 py-2" />
        </div>
      ...
      <p className="text-gray-600 mb-6">Update your password to keep your account secure</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="password" defaultValue="" className="w-full border rounded-md px-3 py-2" />
          </div>
          <div>

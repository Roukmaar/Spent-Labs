    ...
    <section className='space-y-5 w-full px-4 sm:px-6'>
            ...
            <div  className='border border-blue-500 p-4 rounded-xl shadow-sm'>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center text-xs text-gray-500 mt-4 gap-1'>
                        <span className='flex gap-1 items-center'><FontAwesomeIcon icon={faCalendar} className='text-black size-3'/> 04/01/2024</span>
                        <span>👥 3</span>
                    </div>
                    ...
                    <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center text-xs text-gray-500 mt-4 gap-1'>
                        <span className='flex gap-1 items-center'><FontAwesomeIcon icon={faCalendar} className='text-black size-3'/> 24/01/2026</span>
                        <span>👥 2</span>
                    </div>
                    <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center mt-3 text-sm gap-2'>
                        <button className='text-gray-600'>Edit</button>
        ...
        <div  className='border border-amber-500 p-4 rounded-xl shadow-sm'>
            ...
            <div className='bg-white p-4 rounded-xl shadow-sm'>
                ...
                <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center text-xs text-gray-500 mt-4 gap-1'>
                    <span className='flex gap-1 items-center'><FontAwesomeIcon icon={faCalendar} className='text-black size-3'/> 14/12/2025</span>
                    <span>👥 5</span>
                </div>
                <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center mt-3 text-sm gap-2'>
                    <button className='text-gray-600'>Edit</button>
        ...
        <div  className='border border-green-500 p-4 rounded-xl shadow-sm'>
            ...
            <div className='bg-white p-4 rounded-xl shadow-sm'>
                ...
                <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center text-xs text-gray-500 mt-4 gap-1'>
                    <span className='flex gap-1 items-center'><FontAwesomeIcon icon={faCalendar} className='text-black size-3'/> 04/01/2026</span>
                    <span>👥 4</span>
                </div>
                <div className='flex flex-col sm:flex-row sm:justify-between items-start sm:items-center mt-3 text-sm gap-2'>
                    <button className='text-gray-600'>Edit</button>
